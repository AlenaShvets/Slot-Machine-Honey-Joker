package com.happy.honeyjoker.ImageViewScrolling;
...
public class ImageViewScrolling extends FrameLayout {
    ...
    private void setImage(ImageView image_view, int value) {
        if(value == Util.BAR)
            ...
            image_view.setImageResource(R.drawable.sevent);
            ...
            image_view.setImageResource(R.drawable.watermelon);
